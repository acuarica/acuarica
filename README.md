...
I worked in the Web3 space for more than 3 years.
I worked with [Ethereum](https://ethereum.org/), [Hedera](https://hedera.com/), [NEAR](https://near.org/), [Avalanche](https://www.avax.network/), [EOS/WAX](https://www.wax.io/) and [Everscale (TON)](https://everscale.network/) using **Solidity**, **Rust** and **TypeScript/JavaScript**.
...
[![Readme Card](https://github-stats-extended.vercel.app/api/pin/?username=acuarica&repo=evm&theme=dracula)](https://github.com/acuarica/evm)
